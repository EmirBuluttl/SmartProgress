...
router.get("/previous-set-lookup", (req, res, next) => workoutController.previousSetLookup(req, res, next));
router.get("/:id", (req, res, next) => workoutController.getById(req, res, next));
