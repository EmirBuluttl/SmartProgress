...
import { AppTourControllerProvider, useInlineAppTour } from "../contexts/AppTourController";
...
export default function TabNavigator(props: any) {
    return <TabNavigatorShell {...props} />;
}
...
function TabNavigatorInner({ route, tourCompleteNoticeVisible, onCloseTourCompleteNotice }: any) {
    ...
    useEffect(() => {
        if (!tourVisible || activeTabIndex === null) return;
        switchToTab(activeTabIndex, true, 460);
    }, [activeTabIndex, screenWidth, tourVisible]);
